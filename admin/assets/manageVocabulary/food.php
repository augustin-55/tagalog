...
<section>
    <article class="table-mVocabulary">
        <table >
            ...
            <tbody>
                <?php while ($data = $food->fetch()) { ?>
                <tr>
                    <td><img src="../assets/pictures/vocabulary/cooking/<?php echo $data['picture']; ?>" alt="picture <?php echo $data['english']; ?>"></td>
                    <td><?php echo $data['english']; ?></td>
                    <td><?php echo $data['tagalog']; ?></td>
                    <td><?php echo $data['french']; ?></td>
                    <td><a href="update-forms-admin.php?update=vocabulary&display=food&id=<?php echo $data['id']; ?>"><i class="fas fa-edit"></i></a></td>
                    <td><a href="assets/manageVocabulary/controller/delete.php?manageVocabulary=food&id=<?php echo $data['id']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <article class="form-mVocabulary">
        <h4>Add a word</h4>
        <form action="assets/manageVocabulary/controller/add.php?manageVocabulary=food" method="POST">
            <div>
